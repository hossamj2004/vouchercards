...
//Disable Sort For All *************************************************
$( ".admindisablesort #dataTables-example tbody" ).sortable({
  cancel: "tr"
});
		...
		$(function()
			{
				$("#filter_select").change(function()
					{
						window.location='#' + this.value // put url by php
					});
			});
	});
		...
		(function($)
			{
				$(window).load(function()
					{
						$("body").mCustomScrollbar(  { scrollInertia: 0, mouseWheelPixels: 100 });
					});
			})(jQuery);
	});
...
$(document).ready(function()
	{
		...
		* handle date field
		*/
		jQuery('input[data-type=dateTime]').datetimepicker({format: 'Y-m-d H:i:00'});
		...
		$(document).ready(function()
			{
				...
				$("#start_datetime_txt").datetimepicker(
					{
						format: 'Y-m-d H:m:s', minDate : new Date() ,minDateTime: new Date(),
		...
		*/
		...
		/**
		* handle multi select to check boxes
		*/
		$(document).ready(function()
			{
				$('select[multiple=multiple]').multicheck(
					{
						label_wrap: '<div checked="checked" class="checkbox"></div>'
					});
...
// need to write javascript that move inputs into hidden fields and add them to form with diffrent names
$('.nested-form').submit(function(e)
	{
		e.preventDefault();
		var lastRepeatingGroup = $('.nested-form').last();
...
$('.deleteFight').click(function(e)
	{
		...
		var other_fights = current_fight.siblings('.nested-form');
...
$("#myModal").on("show.bs.modal", function(e) {
	...
	$(this).find(".modal-content").html($('#loading_bar_ajax').html());
